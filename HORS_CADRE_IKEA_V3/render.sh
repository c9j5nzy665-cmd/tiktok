...
if [ ! -s assets/voice.ogg ]; then
  cat \
    assets/voice8_parts/part00.b64 \
    assets/voice8_parts/part01.b64 \
    assets/voice8_parts/part02.b64 \
    assets/voice8_parts/part03.b64 \
    assets/voice8_parts/part04.b64 \
    assets/voice8_parts/part05.b64 \
    assets/voice8_parts/part06.b64 \
    assets/voice8_parts/part07.b64 \
    assets/voice8_parts/part08.b64 \
    assets/voice8_parts/part09.b64 \
    assets/voice8_parts/part10.b64 \
    assets/voice8_parts/part11.b64 \
...
PY
  ...
  ffmpeg -y -loop 1 -i "$src" -t "$dur" -an \
    -vf "scale=1400:2400:force_original_aspect_ratio=increase,crop=1400:2400,zoompan=z='min(zoom+0.00032,1.055)':x='iw/2-(iw/zoom/2)':y='ih/2-(ih/zoom/2)':d=${frames}:s=1080x1920:fps=30,fade=t=in:st=0:d=0.10,fade=t=out:st=${fadeout}:d=0.10" \
    -c:v libx264 -preset medium -crf 18 -pix_fmt yuv420p "$out"
}
